...
public class CalendarDateRangePickerViewController: UICollectionViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem?.tintColor = UIColor.init(red: 255/255, green: 113/255, blue: 18/255, alpha: 1)
        ...
        self.navigationItem.rightBarButtonItem?.tintColor = UIColor.init(red: 255/255, green: 113/255, blue: 18/255, alpha: 1)
